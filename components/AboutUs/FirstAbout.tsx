        ...
        >
          <SwiperSlide>
            ...
            <p className="mt-6 opacity-75 text-xs md:text-xl">
              ...
              Ваш бізнес виділявся. B цьому Вам допоможе наш програміст,
          ...
          <SwiperSlide>
            ...
            <p className="mt-6 opacity-75 text-xs">
              ...
              клієнтів. PPC-менеджери проведуть індивідуальну піар-кампанію,
          ...
          <SwiperSlide>
            ...
            <p className="mt-6 opacity-75 text-xs">
              Допоможуть Вам y будь-якій ситуації. Проконсультують, деатьльно
