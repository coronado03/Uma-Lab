...
function Footer() {
  return (
    <div className='flex bg-black justify-center flex-col lg:flex-row lg:gap-x-48 mx-auto text-white w-11/12 z-2 py-32'> 
      
      <h1 className="text-6xl font-semibold text-center self-center mb-14">Заявка на послугу</h1>
